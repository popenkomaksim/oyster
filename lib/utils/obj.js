...
function getParamsObject(context) {
    ...
    if (context.headers.x_access_token) {
        params.access_token = context.headers.x_access_token;
    }
    if (context.headers.x_app_id) {
        params.app_id = context.headers.x_app_id;
    }
    if (context.headers.x_app_secret) {
        params.app_secret = context.headers.x_app_secret;
    }
